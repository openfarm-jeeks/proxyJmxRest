 ...
 * 
 */
public class GetWildcardJmxData extends ServerResource {
	private static final Log log = LogFactory.getLog(GetWildcardJmxData.class);
	 ...
	 */
	@Get
	public GetWildCardMultiDataResponse getWildcardJmxData() {
			...
			GetWildCardMultiDataResponse jmxResponse = new GetWildCardMultiDataResponse();
			...
			try {
				...
				jmxResponse = jmxQuery.getWildCardJmxData(request.getJmxObject(), request.getJmxProperty(), request.getJmxKey());
			} catch (Exception e) {
				ErrorJmx errorJmx = new ErrorJmx();
