 ...
 * 
 */
public class GetWildcardKeysForObjects extends ServerResource {
	private static final Log log = LogFactory.getLog(GetWildcardKeysForObjects.class);
	 ...
	 */
	@Get
	public GetMultiObjectKeysResponse getJmxData() {
		...
		GetMultiObjectKeysResponse jmxResponse = new GetMultiObjectKeysResponse();
		...
		try {
			...
			jmxResponse = jmxQuery.getWildcardJmxKeys(request.getJmxObject(), request.getJmxProperty());
		} catch (Exception e) {
			ErrorJmx errorJmx = new ErrorJmx();
