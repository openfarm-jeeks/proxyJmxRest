...
/**
 * @author Openfarm
 * Object to map get parameters for o getJmxData rest request
 */
public class GetJmxDataRequest {
	...
	/**
	 * 
	 * @param hostName jmx hostname 
	 * @param port jmx port
	 * @param objectName jmx target object
	 * @param property jmx property in the object
	 * @param key key for compisite properties
	 */
	public GetJmxDataRequest(String hostName, String port, String objectName, String property, String key) {
